 ...
 * <p>The {@code HList} interface places additional stipulations, beyond those specified in the {@code HCollection} interface, on the contracts of the {@code iterator}, {@code add}, {@code remove}, {@code equals}, and {@code hashCode} methods. Declarations for other inherited methods are also included here for convenience.</p>
 ...
 * <p>The {@code HList} interface provides two methods to search for a specified object. From a performance standpoint, these methods should be used with caution. In many implementations they will perform costly linear searches.</p>
 ...
 * <p>Note: While it is permissible for lists to contain themselves as elements, extreme caution is advised: the equals and hashCode methods are no longer well defined on a such a list.</p>
 ...
 * at the option of the implementation. Such exceptions are marked as "optional" in the specification for this interface.</p>
 * @author dacco
 */
